...
export class CreateArticleComponent implements OnInit {
  ...
  tinyOptions = {
    ...
    plugins: 'image, link, preview, table, emoticons, paste, code, media', // 插件 图片/超链接/预览/表格/表情/粘贴
    default_link_target: "_blank", // 打开的超链接新的地址打开
    image_advtab: true, // 上传的图片的css样式（内置style）、边距（margin）和边框（border）
    toolbar: 'undo redo | formatselect | bold italic backcolor | table tabledelete | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformat | help | image media | link | emoticons | preview',
